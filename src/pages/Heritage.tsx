...
const LOCATIONS: Location[] = [
  {
    ...
    gallery: [
      'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/%C4%90%C3%ACnh_B%C3%ACnh_M%E1%BB%B9.jpg/1280px-%C4%90%C3%ACnh_B%C3%ACnh_M%E1%BB%B9.jpg',
      'https://images.baoangiang.com.vn/image/fckeditor/upload/2022/20221001/images/1.jpg',
      'https://images.baoangiang.com.vn/image/fckeditor/upload/2022/20221001/images/2.jpg',
      'https://images.baoangiang.com.vn/image/fckeditor/upload/2022/20221001/images/3.jpg',
    ],
  ...
  },
  {
    ...
    manager: 'Hội Làng Nghề Bánh Tráng Bình Mỹ',
    phone: '0912 345 678',
    ...
    description: 'Làng nghề trăm năm tuổi nổi tiếng với bánh tráng phơi sương thủ công — đặc sản mang hương vị quê nhà.',
    story: 'Từ tờ mờ sáng, khi cả xã còn đang ngủ, những người thợ làng bánh tráng đã nhóm lửa, xay bột và bắt đầu tráng những tấm bánh đầu tiên trong ngày. Hơn một trăm năm, nghề tráng bánh Bình Mỹ không thay đổi — chỉ gạo tẻ nguyên chất, nước sạch và bàn tay khéo léo của người thợ, phơi sương tự nhiên để có độ dẻo đặc trưng.',
    activities: [
    ...
    events: [
      { name: 'Ngày Hội Bánh Tráng', month: 'Tháng 9 hàng năm', desc: 'Triển lãm nghề tráng bánh, thi làm bánh và chợ ẩm thực địa phương — thu hút hàng nghìn du khách mỗi năm.' },
...
const ALL_POSTS = [
  ...
  { id: '7', locationId: 'lang-banh-trang', author: 'Hội Làng Nghề Bánh Tráng', role: 'government' as Role, avatar: 'https://images.unsplash.com/photo-1599566150163-29194dcaad36?auto=format&fit=crop&q=80&w=150', verified: true, time: '1 ngày trước', content: 'Ngày Hội Bánh Tráng tháng 9 sắp tới! Năm nay sẽ có thêm khu trình diễn nghề tráng bánh trực tiếp và cuộc thi "Tấm Bánh Đẹp Nhất" với giải thưởng hấp dẫn. Đón chờ nhé 🎉', likes: 156, comments: 28 },
