...
const seasons = [
  {
    ...
    itinerary:[
      ...
      { time:'10:00', activity:'Ghé xưởng bánh tráng làng nghề', note:'Xem tráng bánh, mua đặc sản làm quà' },
  ...
  },
  {
    ...
    itinerary:[
      ...
      { time:'08:30', activity:'Thăm làng nghề bánh tráng — mùa vào sản xuất cao điểm', note:'Xem phơi bánh, tráng bánh, mua trực tiếp' },
...
const ANNUAL_EVENTS = [
  ...
  { name:'Ngày Hội Bánh Tráng', month:'Tháng 9', type:'Làng nghề', desc:'Triển lãm nghề tráng bánh và chợ ẩm thực địa phương — sự kiện du lịch nổi bật.' },
